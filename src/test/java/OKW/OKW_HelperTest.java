...
public class OKW_HelperTest
	...
	@BeforeClass
        ...
        @Test
        public void TC_GetLeftFromDelimiterMultipleCharacterDelemeter()
        {
        ...
        public void TC_GetLeftFromDelimiterNumber_OKWDelimiterCountOutOfRangeException()
        {
            try
            {
                OKW.OKWLanguage.getInstance().setLanguage("en");
        ...
        @Test
        public void TC_GetRigthFromDelimiterNumber_2c()
        {
        ...
        @Test
        public void TC_String2Boolean_false()
        {
            Boolean actual = true;
            Boolean expected = true;
        ...
        @Test
        public void TC_String2Boolean_true()
        {
            Boolean actual = false;
            Boolean expected = false;
        ...
        @Test
        public void TC_String2Boolean_false_lower()
        {
            Boolean actual = false;
            Boolean expected = false;
        ...
        @Test
        public void TC_String2Boolean_true_lower()
        {
            Boolean actual = false;
            Boolean expected = true;
        ...
        public void TC_String2Boolean_true_OKWNotAllowedValueException()
        {
            try
            {
                Boolean Return = OKW_Helper.String2Boolean("Uschi");
                Assert.fail();
            }
