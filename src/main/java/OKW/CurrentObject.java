...
public class CurrentObject // : OKWSingeltonBase<CurrentObject>
{
	...
	*/
	FrameObjectDictionary	myFrameObjectDictionary	= null;
	...
	* \date 2012.12.02
	...
	private CurrentObject()
	{
		...
		myFrameObjectDictionary = FrameObjectDictionary.getInstance();
	}
	...
	* \date 2012.11.01
	 */
	@SuppressWarnings("unchecked")
	public ArrayList<String> CallMethodReturn_ListString( String fpsMethod, String fpsParam_1, String fpsParam_2 ) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException
	{
		ArrayList<String> lvLsReturn = new ArrayList<String>();
		Boolean bOK = false;
	...
	* \date 2012.11.01
	 */
	@SuppressWarnings("unchecked")
	public ArrayList<String> CallMethodReturn_ListString(String fpsMethod, ArrayList<String> fpLsParameter_1) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException
        {
            ArrayList<String> lvLsReturn = new ArrayList<String>();
            Boolean bOK = false;
	...
	* \date 2013.05.17
	 */
	public String CallMethodReturn_String( String fpsMethod, String fpsParameter_1 ) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException
	{
		String lvsReturn = "";
		Boolean bOK = false;
	...
	* \date 2012.12.15
	...
	public void Init()
	{
		...
		try
		{
			...
			this.myFrameObjectDictionary = FrameObjectDictionary.getInstance();
		}
		finally
		{
			Log.LogFunctionEndDebug();
	...
	* \date 2012.11.01
	...
	public Object SetChildName( String fpsChildName )
	{
		...
		try
		{
			...
			{
				Log.LogPrintDebug(this.LM.GetMessage("SetChildName", "SetChildwindowNameDebug", this.cvsWindowName,
						this.cvsChildName));
	...
	private void UpdateObject()
	{
		...
		try
		{
			...
			else
			{
				...
				this.cvoObject = this.myFrameObjectDictionary.GetChildObjectByName(this.cvsWindowName,
						this.cvsChildName);
			}
		}
		finally
