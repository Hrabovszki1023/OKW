...
import OKW.Log.*;
    ...
    /// \date 2012.11.01
    public class CurrentObject // : OKWSingeltonBase<CurrentObject>
    {
        ...
        /// Auf dieses Fenster beziehen sich alle GUI Kind-Objekte, die mit  "cvsChildName" gegeben sind.
        /// 
        ///
        /// \~english
        /// \brief
        ...
        /// 
        //private static readonly CurrentObject instance = new CurrentObject();
        ...
        /// * "Frm_Login.User" als Refernz auf das Kindobjekt "User" des fachlichen Fensters "Login"
        /// 
        ///
        /// \~english
        /// \brief
        ...
        /// 
        /// \remark Die Datei mit den Sprachabhängigen Log-Ausgaben zu dieser Klasse ist:
        ...
        /// Eigenschaft enthält die Referenzierung auf das aktuelle Fenster- oder Kindobjekt.
        /// 
        ///
        /// \~english
        /// \brief
        ...
        /// Works in an automatized call: The right class is given after input of the frame Object
        ...
        /// \~german
        /// \brief
        /// Initialisiert eine neue Instanz der <see cref="OKW.CurrentObject"/> Klasse
        /// Nicht öffentlicher Konstruktor: Verwenden Sie <see cref="OKW.CurrentObject.Instance"/> um die Instanz
        ...
        ///   - Verwenden Sie diese Eigenschaft um die Instanz dieser Klasse zu erhalten.
        ...
        private static CurrentObject instance;
        ...
        public void CallMethod(String fpsMethod)
        {
            ...
            try
            {
                Class myTypeObject = this.cvoObject.getClass();
                Method myMethod = myTypeObject.GetMethod(fpsMethod,
                ...
                else
                {
                    ...
                    myMethod.invoke( cvoObject, null);
                }
            }
            finally
            {
        ...
        public void CallMethod(String fpsMethod, ArrayList<String> fpLsParameter)
        {
            ...
            Object[] lvoParameter = new Object[1];
            lvoParameter[0] = fpLsParameter;
            try
            {
                Class myTypeObject = this.cvoObject.getClass();
                Method myMethod = myTypeObject.GetMethod(fpsMethod,
                                                                 BindingFlags.Public | BindingFlags.Instance,
                                                                 null,
                                                                 new Type[] { typeof(ArrayList<String>) },
                                                                 null);
                // Existiert die Methode des Objektes?
                if (myMethod == null)
                {
                ...
                {
                    // Ja, Methode via invoke aufrufen
                    myMethod.invoke(this.cvoObject, lvoParameter);
                }
            }
            finally
            {
        ...
        {
            Log.LogFunctionStartDebug("CallMethod", "String fpsMethod", fpsMethod, "ArrayList<String> fpLsParameter_1",  fpLsParameter_1.toString(), "String fpsParameter_2", fpsParameter_2);
            Object[] lvoParameter = new Object[2];

            lvoParameter[0] = fpLsParameter_1;     // Der letzte Parameter ist immer der zu übergebende Wert
            lvoParameter[1] = fpsParameter_2;      // Hier sind Kooerdinaten usw. zu finden
            try
            {
                Class myTypeObject = this.cvoObject.getClass();
                Method myMethod = myTypeObject.GetMethod(fpsMethod,
                                                                 BindingFlags.Public | BindingFlags.Instance,
                                                                 null,
                                                                 new Type[] {typeof(ArrayList<String>), typeof(String)},
                                                                 null);
                // Existiert die Methode des Objektes?
                if (myMethod == null)
                {
        ...
        public void CallMethod(String fpsMethod, String fpsParameter_1)
        {
            ...
            Object[] lvoParameter = new Object[1];
            lvoParameter[0] = fpsParameter_1; // Hier sind z.B. Kooerdinaten usw. zu finden
            try
            {
                Class myTypeObject = this.cvoObject.getClass();
                Method myMethod = myTypeObject.GetMethod(fpsMethod,
        ...
        public void CallMethod(String fpsMethod, String fpsParameter_1, String fpsParameter_2)
        {
            ...
            Object[] lvoParameter = new Object[2];
            lvoParameter[0] = fpsParameter_1; // Hier sind z.B. Kooerdinaten usw. zu finden
            lvoParameter[1] = fpsParameter_2; // Auch hier sind Kooerdinaten usw. zu finden
            try
            {
                Class myTypeObject = this.cvoObject.getClass();
                Method myMethod = myTypeObject.GetMethod(fpsMethod,
        ...
        {
            Log.LogFunctionStartDebug("CallMethod",
            ...
            Object[] lvoParameter = new Object[3];
            lvoParameter[0] = fpsParameter_1;
            lvoParameter[1] = fpsParameter_2;
            lvoParameter[2] = fpsParameter_3;
            try
            {
                Class myTypeObject = this.cvoObject.getClass();
                Method myMethod = myTypeObject.GetMethod(fpsMethod,
        ...
        /// \author Zoltan Hrabovszki
        /// \date 2012.11.01
        public void CallMethod(String fpsMethod, String fpsParameter_1, String fpsParameter_2, ArrayList<String> fpLsValue)
        {
            Log.LogFunctionStartDebug("CallMethod",
                                           "String fpsMethod", fpsMethod,
                                           "String fpsParameter_1", fpsParameter_1,
            ...
            try
            {
                ...
                Method myMethod = myTypeObject.getMethod(fpsMethod,
                                                                 BindingFlags.Public | BindingFlags.Instance,
                                                                 null,
                                                                 new Class[] {typeof(String), typeof(String), typeof(ArrayList<String>)},
                                                                 null);
                // Existiert die Methode des Objektes?
                if (myMethod == null)
                {
        ...
        public Boolean CallMethodReturn_Boolean(String fpsMethod)
        {
            ...
            try
            {
                ...
                {
                    // Ja, Methode via invoke aufrufen
                    lvbReturn = (Boolean)myMethod.invoke(this.cvoObject, null);
                }
            }
            finally
            {
        ...
        public Boolean CallMethodReturn_BooleanPb(String fpsMethod, Boolean fpbParameter_1)
        {
            Boolean lvbReturn = false;
            Object[] lvoParameter = new Object[1];
            lvoParameter[0] = fpbParameter_1;
            Log.LogFunctionStartDebug("CallMethodReturn_BooleanPb",
                                           "String fpsMethod", fpsMethod,
                                           "Boolean fpsParameter_1", fpbParameter_1.toString());
            try
            {
                Class myTypeObject = this.cvoObject.getClass();
                Method myMethod = myTypeObject.getMethod(fpsMethod,
                ...
                {
                    // Ja, Methode via invoke aufrufen
                    lvbReturn = (Boolean)myMethod.invoke(this.cvoObject, lvoParameter);
                }
            }
            finally
            {
        ...
        /// \author Zoltan Hrabovszki
        /// \date 2012.11.01
        public int CallMethodReturn_Int(String fpsMethod)
        {
            Integer lviReturn = 0;
            Boolean bOK = false;
            Log.LogFunctionStartDebug("CallMethodReturn_Int",
                                           "String fpsMethod", fpsMethod);
            try
            {
                Class myTypeObject = this.cvoObject.getClass();
                ...
                {
                    // Ja, Methode via invoke aufrufen
                    lviReturn = (Integer)myMethod.invoke(this.cvoObject, null);
                }
                bOK = true;
            }
            finally
        ...
        public ArrayList<String> CallMethodReturn_ListString(String fpsMethod)
        {
            ...
            try
            {
                ...
                {
                    // Ja, Methode via invoke aufrufen
                    lvLsReturn = (ArrayList<String>)myMethod.invoke(this.cvoObject, null);
                }
                bOK = true;
            }
            finally
        ...
        /// \author Zoltan Hrabovszki
        /// \date 2012.11.01
        public ArrayList<String> CallMethodReturn_ListString(String fpsMethod, String fpsParam1, String fpsParam2)
        {
            ArrayList<String> lvLsReturn = new ArrayList<String>();
            Object[] lvoParameter = new Object[2];
            Boolean bOK = false;
            lvoParameter[0] = fpsParam1;
            lvoParameter[1] = fpsParam2;
            Log.LogFunctionStartDebug("CallMethodReturn_ListString",
                                           "String fpsMethod", fpsMethod,
                                           "String fpsParam1", fpsParam1,
                                           "String fpsParam2", fpsParam2);
            try
            {
                Class myTypeObject = this.cvoObject.getClass();
                Method myMethod = myTypeObject.GetMethod(fpsMethod,
                                                                 BindingFlags.Public | BindingFlags.Instance,
                                                                 null,
                                                                 new Class[] {typeof(String), typeof(String)},
                                                                 null);
                // Existiert die Methode des Objektes?
                if (myMethod == null)
                {
                ...
                {
                    // Ja, Methode via invoke aufrufen
                    lvLsReturn = (ArrayList<String>)myMethod.invoke(this.cvoObject, lvoParameter);
                }
                bOK = true;
            }
            finally
        ...
        /// \author Zoltan Hrabovszki
        /// \date 2012.11.01
        public ArrayList<String> CallMethodReturn_ListString(String fpsMethod, ArrayList<String> fpLsParameter_1)
        {
            ArrayList<String> lvLsReturn = new ArrayList<String>();
            Object[] lvoParameter = new Object[1];
            Boolean bOK = false;
            lvoParameter[0] = fpLsParameter_1;
            Log.LogFunctionStartDebug("CallMethodWithReturn",
                                           "String fpsMethod", fpsMethod,
            ...
            try
            {
                ...
                Method myMethod = myTypeObject.getMethod(fpsMethod,
                                                                 BindingFlags.Public | BindingFlags.Instance,
                                                                 null,
                                                                 new Class[] {typeof(ArrayList<String>)},
                                                                 null);
                // Existiert die Methode des Objektes?
                if (myMethod == null)
                {
        ...
        /// \author Zoltan Hrabovszki
        /// \date 2012.11.01
        public ArrayList<String> CallMethodReturn_ListString(String fpsMethod, String fpsParameter_1, String fpsParameter_2, ArrayList<String> fpLsParameter_3) throws Exception, SecurityException
        {
            ArrayList<String> lvLsReturn = new ArrayList<String>();
            Object[] lvoParameter = new Object[3];
            Boolean bOK = false;
            lvoParameter[0] = fpsParameter_1;
            lvoParameter[1] = fpsParameter_2;
            lvoParameter[2] = fpLsParameter_3;
            Log.LogFunctionStartDebug("CallMethodReturn_ListString",
                                           "String fpsMethod", fpsMethod,
        ...
        /// \author Zoltan Hrabovszki
        /// \date 2012.11.01
        public String CallMethodReturn_String(String fpsMethod)
        {
            String lvsReturn = "";
            Boolean bOK = false;
            ...
            try
            {
                ...
                {
                    // Ja, Methode via invoke aufrufen
                    lvsReturn = (String)myMethod.invoke(this.cvoObject, null);
                }
                bOK = true;
            }
            finally
        ...
        /// \author Zoltan Hrabovszki
        /// \date 2013.05.17
        public String CallMethodReturn_String(String fpsMethod, String fpsParameter_1)
        {
            String lvsReturn = "";
            Object[] lvoParameter = new Object[1];
            Boolean bOK = false;
            ...
            try
            {
                ...
                {
                    // Ja, Methode via invoke aufrufen
                    lvsReturn = (String)myMethod.invoke(this.cvoObject, lvoParameter);
                }
                bOK = true;
            }
            finally
        ...
        /// 
        /// \param fpsFunctionalname Fachlicher Name, der geprüft werden soll (String).
        /// \return true, falls der fachliche Name kein "verbotenes" Zeichen enthält, sonst false
        ///
        /// \~english
        /// \brief
        ...
        /// \return true, if the professional name contains no "forbidden" sign, otherwise false
        ///
        /// \~
        /// \author Zoltan Hrabovszki
        /// \date 2012.11.01
        public Boolean CheckCharacter(String fpsFunctionalname)
        {
            ...
            try
            {
                ...
                {
                    // FrameObjekt-Name enthält nicht erlaubte Zeichen, daher Exception auslösen.
                    String errorText = this.LM.GetMessage("CheckCharacter", "OKWFrameObjectIllegalNameCharacterException", fpsFunctionalname);
        ...
        public Object GetCurrentObject()
        {
            ...
            catch
            {
                if (bOK)
                {
                    Log.LogFunctionEndDebug(this.cvoObject.getClass(),.fullName());
                }
                else
                {
                    Log.LogFunctionEndDebug();
        ...
        public void Init()
        {
            ...
            try
            {
                this.LM = new LogMessenger(this.getClass().Name);
                this.cvoObject = null;
                this.cvsChildName = "";
                this.cvsWindowName = "";
                this.cvsObjectName = "";
                this.myFrameObjectDictionary = null;
                this.myFrameObjectDictionary = new FrameObjectDictionary();
            }
            finally
            {
                Log.LogFunctionEndDebug();
        ...
        /// This should help in error or exception when debugging by outputting the current data Object.<br/>
        ...
        public void LogObjectData()
        {
            ...
            try
            {
                ...
                Log.LogPrint(this.LM.GetMessage("LogObjectData", "Class of Object", this.cvoObject.getClass().Name));
                Log.LogPrint(this.LM.GetMessage("LogObjectData", "FullNameOfObject", this.cvsObjectName));
            }
            catch (SystemException e)
            {
                Log.LogPrint(e.Message);
            }
            finally
            {
                Log.ResCloseList();
        ...
        /// 
        /// \return 
        /// Liefert die Objektreferenz auf das aktuelle Objekt this.cvoObject aus dem Rückgabewert.
        /// \param fpsChildName Fachlicher Name des Kind-Objektes.
        /// 
        /// \note Wichtig! Das Fenster-Objekt muss gesetzt sein!<br/>
        /// Ist dies nicht der Fall, wird eine OKW.OKW_Kernel_Exception Exception ausgelöst
        ///
        /// \~english
        /// \brief
        ...
        /// \author Zoltan Hrabovszki
        /// \date 2012.11.01
        public Object SetChildName(String fpsChildName)
        {
            Boolean bOK = false;
            Log.LogFunctionStartDebug("CurrentObject.SetChildName", "String fpsChildName", fpsChildName);
            Log.LogPrintDebug(this.LM.GetMessage("SetChildName", "GivenWindownameDebug"));
            try
            {
                if (this.cvsWindowName != String.Empty)
                {
                    Log.LogPrintDebug(this.LM.GetMessage("SetChildName", "SetChildwindowNameDebug", this.cvsWindowName, this.cvsChildName));
        ...
        /// \author Zoltan Hrabovszki
        /// \date 2012.11.01
        public Object SetWindowName(String fpsWindowName)
        {
            Object lvoReturn = new Object();
            Boolean bOK = false;
        ...
        /// \author Zoltan Hrabovszki
        /// \date 2012.11.01
        private Object ResetToWindow()
        {
            Boolean bOK = false;
            Log.LogFunctionStartDebug("CurrentObject.ResetToWindow");
            Log.LogPrintDebug(this.LM.GetMessage("ResetToWindow", "ResetToWindowDebug"));
            try
            {
                this.cvsChildName = "";
                this.UpdateObject();
        ...
        ///   * OKW.CurrentObject.myFrameObjectDictionary erhält eine Objekt-Referenz auf das zugehörige Frame-Objekt.
        /// 
        /// \note Diese Methode wird von OKW.CurrentObject.SetWindowName und OKW.CurrentObject.SetChildName aufgerufen.
        /// Diese Method sorgt dafür, dass die in SetWindowName und SetChildName gegebenen Werte
        ...
        ///   * OKW.CurrentObject.myFrameObjectDictionary is receiving an Object reference to the corresponding frame Object.
        /// 
        /// \note This method is called by OKW.CurrentObject.SetWindowName and OKW.CurrentObject.SetChildName.
        /// This method takes care, that the values given in SetWindowName and SetChildName will be instantiated in the corresponding frame Object.
        ///
        /// \~
        /// \author Zoltan Hrabovszki
        /// \date 2012.11.01
        private void UpdateObject()
        {
            ...
            try
            {
                if (this.cvsChildName == "")
                {
                    ...
                    this.cvoObject = this.myFrameObjectDictionary.GetParentObjectByName(this.cvsWindowName);
                    // "frm_" + this.cvsWindowName; //< 1. Set the cvsObjectName for a window-Object.
                ...
                else
                {
                    ...
                    this.cvoObject = this.myFrameObjectDictionary.GetChildObjectByName(this.cvsWindowName, this.cvsChildName);
                }
            }
            finally
            {
