...
{
	/*
	 * \~german \brief Variable hält den Pfad zum XML Verzeichniss vor
	 *
	 * \~english \brief Variable has in store the path to Folder _XML_.
	 * 
	 * \~ \author Zoltán Hrabovszki \date 2014_10_25
	 */
	private String	Folder_XML;

	/*
	 * \~german \brief Variable hält den Pfad zum _LogMessages_ Verzeichniss vor
	 *
	 * \~english* \brief Variable has in store the path to Folder _LogMessages_.
	 * 
	 * \~ \author Zoltán Hrabovszki \date 2014_10_25/jnic
	 */
	private String	Folder_LogMessages;

	/*
	 * \~german \brief Variable hält Pfad und Dateinamen der OKW_Ini.xml vor.
	 * 
	 *
	 * \~english* \brief Variable has in store the path- and filename of
	 * OKW_Ini.xml.
	 * 
	 *
	 * \~ \author Zoltán Hrabovszki \date 2014_10_25
	...
	/*
	 * \~german \brief Privates Feld der Eigenschaft OKW_Const. Enthält den Pfad
	...
	/*
	 * \~german \brief Privates Feld der Eigenschaft OKW_Keymaps. Enthält den
	...
	/*
	 * \~german \brief Privates Feld der Eigenschaft OKW_Memorize. Enthält den
	...
	/*
	 * \~german \brief Privates Feld der Eigenschaft OKW_Docu. Enthält den Pfad
	...
	/*
	 * \~german \brief Privates Feld der Eigenschaft OKW_ImplementationMatrix.
	...
	/*
	 * \~german \brief Konstruktor der Klasse OKW_Enviroment.
	 * 
	...
	/*
	 * \~german \brief Property get/set von __Folder_XML
	 * 
	 * \see Beschreibung des Wertes siehe: OKW_Enviroment.__Folder_XML \~english
	 * \~ \author Zoltán Hrabovszki \date 2013.11.28
	 */
	// [XmlIgnore]
	public String getFolder_XML()
	{
		return OKW.OKW_FileHelper.ConvertDirectorySeperator(this.Folder_XML);
	}
	...
	{
		return OKW.OKW_FileHelper.ConvertDirectorySeperator(this.Folder_LogMessages);
	}
	...
	{
		String myPath = MyParser.ParseMe(this.File_OKW_Ini_xml);
		return OKW.OKW_FileHelper.ConvertDirectorySeperator(myPath);
	}
	...
	/*
	 * \~german \brief Property get/set von File_OKW_Keymaps_xml
	 * 
	...
	{
		String myPath = MyParser.ParseMe(this.File_OKW_Keymaps_xml);
		return OKW.OKW_FileHelper.ConvertDirectorySeperator(myPath);
	}
	...
	/*
	 * \~german \brief Property get/set von File_OKW_Memorize_xml
	 * 
	...
	{
		String myPath = MyParser.ParseMe(this.File_OKW_Memorize_xml);
		return OKW.OKW_FileHelper.ConvertDirectorySeperator(myPath);
	}
	...
	/*
	 * \~german \brief Property get/set von File_OKW_ImplementationMatrix_xml
	 * 
	 * \see Beschreibung des Wertes siehe:
	 * OKW_Enviroment.File_OKW_ImplementationMatrix_xml \~english \~ \author
	 * Zoltán Hrabovszki \date 2013.11.28
	 */
	// [XmlElement("File_OKW_ImplementationMatrix_xml")]
	public String getFile_OKW_ImplementationMatrix_xml()

	{
		String myPath = MyParser.ParseMe(this.File_OKW_ImplementationMatrix_xml);
		return OKW.OKW_FileHelper.ConvertDirectorySeperator(myPath);
	}
	...
	/*
	 * \~german \brief Property get/set von File_OKW_Const_xml
	 * 
	...
	{
		String myPath = MyParser.ParseMe(this.File_OKW_Const_xml);
		return OKW.OKW_FileHelper.ConvertDirectorySeperator(myPath);
	}
	...
	{
		String myPath = MyParser.ParseMe(this.File_OKW_Docu_xml_);
		return OKW.OKW_FileHelper.ConvertDirectorySeperator(myPath);
	}
