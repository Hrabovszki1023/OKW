...
public class OKW_Parser extends Parser {
	...
	public static final int
		FOLDER_XML=6, ENVVAL=15, FILE_OKW_IMPLEMENTATIONMATRIX_XML=9, TEXT=2, 
		FOLDER_LOGMESSAGES=5, FILE_OKW_MEMORIZE_XML=12, VALUE=16, FILE_OKW_DOCU_XML=8, 
		KEYVALUE=14, KLAMMERZU=4, FILE_OKW_CONST_XML=7, FILE_OKW_INI_XML=10, KLAMMERAUF=1, 
		WS=3, FILE_OKW_KEYMAPS_XML=11, KEYPREFIX=13;
