...
public class OKW_WaitForValue
{
        ...
        public ArrayList<String> getCaption(ArrayList<String> Expected, Integer SleepForMillis, Integer MaxWaitMilis) throws InterruptedException
        {
        ...
        public ArrayList<String> getValue(ArrayList<String> Expected, Integer SleepForMillis, Integer MaxWaitMilis) throws InterruptedException
        {
                ArrayList<String> ALReturn = null;
        ...
        public ArrayList<String> getLabel(ArrayList<String> Expected, Integer SleepForMillis, Integer MaxWaitMilis) throws InterruptedException
        {
                ArrayList<String> ALReturn = null;
        ...
        public ArrayList<String> getTooltip(ArrayList<String> Expected, Integer SleepForMillis, Integer MaxWaitMilis) throws InterruptedException
        {
                ArrayList<String> ALReturn = null;
