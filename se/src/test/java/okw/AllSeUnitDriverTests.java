...
@RunWith( Suite.class )
@SuiteClasses({
                okw.SeInputButton.SeInputButton_HTMLUnitDriver_Test.class,
                okw.SeInputCheckbox.SeInputCheckbox_HTMLUnitDriver_Test.class,
                okw.SeInputField.SeInputField_HTMLUnitDriver_Test.class,
                okw.SeInputRadio.SeInputRadio_HTMLUnitDriver_Test.class,
                okw.SeRadioList.SeRadioList_HTMLUnitDriver_Test.class,
