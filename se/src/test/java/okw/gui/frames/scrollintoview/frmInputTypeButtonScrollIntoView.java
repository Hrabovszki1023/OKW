...
@OKW (FN="Scroll Into View InputTypeButton",
      WaitForMe_PT=500,
      WaitForMe_TO=5
     )
public class frmInputTypeButtonScrollIntoView extends SeBrowserChild
{
...
public SeInputButton Button2_unten = new SeInputButton("4T!Button 2 unten", this.getLOCATOR() );
    ...
    public frmInputTypeButtonScrollIntoView( )
    {
        setLocator("4T!InputTypeButtonScroll");
    }
