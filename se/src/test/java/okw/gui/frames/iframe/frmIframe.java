 ...
 */
@OKW( FN = "IFrameWithID" )
public class frmIframe extends SeBrowserChild
{
    /** \~german
    ...
    public IGUIChildwindow Anzeige  = new SeInputText( "//*[@data-harmony-id='textarea']" );
    ...
    public IGUIChildwindow    Text_1   = new SeButton( "//*[@data-harmony-id='Button 1']" );
    ...
    public IGUIChildwindow    Text_2   = new SeButton( "//*[@data-harmony-id='Button 2']" );
    ...
    public IGUIChildwindow User     = new SeInputText( "//*[@data-harmony-id='User']" );

    @OKW( FN = "Password", WaitForMe_PT = 500, WaitForMe_TO = 1, VerifyLabel_PT = 500, VerifyLabel_TO = 3, VerifyIsActive_PT = 500, VerifyIsActive_TO = 3, VerifyValue_PT = 500, VerifyValue_TO = 3, VerifyTooltip_PT = 500, VerifyTooltip_TO = 3, VerifyCaption_PT = 500, VerifyCaption_TO = 3, VerifyExists_PT = 500, VerifyExists_TO = 3, VerifyHasFocus_PT = 500, VerifyHasFocus_TO = 3 )
    public IGUIChildwindow Password = new SeInputText( "//*[@data-harmony-id='Password']" );
    ...
    public frmIframe()
    {
        setLocator( "//*[@data-harmony-id='iframeWithID.htm']" );
    }
}