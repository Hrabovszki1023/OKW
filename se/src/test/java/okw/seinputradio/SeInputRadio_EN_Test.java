...
public class SeInputRadio_EN_Test  extends OKWTestBase
{
	...
	public void tc_MemorizeCaption() throws Exception
	{
		...
		assertEquals("Visa", myMM.get("SeInputRadio_MemorizeCaption_1"));

		EN.MemorizeCaption("American Express", "SeInputRadio_MemorizeCaption_2");
		assertEquals("American Express", myMM.get("SeInputRadio_MemorizeCaption_2"));

		EN.MemorizeCaption("Mastercard", "SeInputRadio_MemorizeCaption_3");
		assertEquals("Mastercard", myMM.get("SeInputRadio_MemorizeCaption_3"));
	...
	public void tc_MemorizeHasFocus() throws Exception
	{
		...
		EN.SetFocus("American Express");
		EN.MemorizeHasFocus("American Express", "SeInputRadio_MemorizeHasFocus");
		assertEquals("YES", myMM.get("SeInputRadio_MemorizeHasFocus"));

		EN.MemorizeHasFocus("Visa", "SeInputRadio_MemorizeHasFocus");
		assertEquals("NO", myMM.get("SeInputRadio_MemorizeHasFocus"));
	...
	public void tc_SetFocus() throws Exception
	{
		...
		EN.VerifyHasFocus("American Express", "NO");
		EN.VerifyHasFocus("Mastercard", "NO");
  ...
  // \date 2016.12.11
	...
	public void tc_VerifyCaptionREGX() throws Exception
	{
		...
		EN.VerifyCaptionREGX("Visa", "Vis.");
		EN.VerifyCaptionREGX("American Express", "American Express");
		EN.VerifyCaptionREGX("Mastercard", "Mastercard");               
