...
package okw.ElementNotInteractableException;
...
*/
@Disabled
public class ElementNotInteractableException_Test extends OKWTestBase
{
...
//    }
    ...
    /**
     * Teste das Schlüsselwort ClickOn( FN ) für Wait for Hidden.
     */ 
    @Test
    public void tcWaitForHidden_ClickOn() throws Exception
    {
        EN.BeginTest( TestName );
        EN.StartApp( ApplicationName );
        EN.TypeKey( "URL", "https://master.works.harmony.ac/hello/wait-for-hidden.html" );

        EN.SelectWindow( "WaitForHiddenObjekt" );
        EN.SetValue( "Name", "Joe" );
        EN.ClickOn("OK");
        
        EN.VerifyValue( "Message", "Hello Joe!" );
     ...
     */ 
    @Test
    public void tcClickOn_2() throws Exception
    {
        EN.BeginTest( TestName );
        EN.StartApp( ApplicationName );
        EN.TypeKey( "URL", "https://master.works.harmony.ac/hello/wait-for-nonexistent.html" );
