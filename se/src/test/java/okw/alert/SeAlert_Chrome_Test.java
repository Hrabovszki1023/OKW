...
public class SeAlert_Chrome_Test extends SeAlert_Test
{
	...
	public static void setUpBeforeClass() throws Exception
	{
        ...
        myLog2HTML = new Log2HTML("Alert_Chrome_Test.html");
  ...
  {
    myLog2HTML.Result2HTML("target/Alert_Chrome_Test.html");
  }
