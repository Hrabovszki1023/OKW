...
public class SeTextField_EN_Test
{
    ...
    public void TC_LogExists_en() throws Exception
    {
        try
        {
            ...
            EN.LogExists("Name");
            //ImplementationMatrix.Instance.SetImplementation("SeTextField", "LogExists", "P");
        }
        catch (Exception e)
        {
            //ImplementationMatrix.Instance.SetImplementation("SeTextField", "LogExists", "F");
            throw e;
        }
    }
    ...
    public void TC_LogHasFocus_en() throws Exception
    {
        try
        {
            ...
            EN.SelectWindow("SeTextField");
            EN.LogHasFocus("Name");
            //ImplementationMatrix.Instance.SetImplementation("SeTextField", "LogHasFocus", "P");
        }
        catch (Exception e)
        {
            //ImplementationMatrix.Instance.SetImplementation("SeTextField", "LogHasFocus", "F");
            throw e;
        }
    }
    ...
    public void TC_LogIsActive_en() throws Exception
    {
        try
        {
            ...
            //ImplementationMatrix.Instance.SetImplementation("SeTextField", "LogIsActive", "P");
        }
        catch (Exception e)
        {
            //ImplementationMatrix.Instance.SetImplementation("SeTextField", "LogIsActive", "F");
            throw e;
        }
    }
    ...
    public void TC_LogLabel_en() throws Exception
    {
        try
        {
            ...
            EN.SelectWindow("SeTextField");
            EN.LogLabel("Name");
            //ImplementationMatrix.Instance.SetImplementation("SeTextField", "LogLabel", "P");
        }
        catch (Exception e)
        {
            //ImplementationMatrix.Instance.SetImplementation("SeTextField", "LogLabel", "F");
            throw e;
        }
    }
    ...
    public void TC_LogToolTip_en() throws Exception
    {
        try
        {
            ...
            EN.SelectWindow("SeTextField");
            EN.LogTooltip("Name");
            //ImplementationMatrix.Instance.SetImplementation("SeTextField", "LogToolTip", "P");
        }
        catch (Exception e)
        {
            //ImplementationMatrix.Instance.SetImplementation("SeTextField", "LogToolTip", "F");
            throw e;
        }
    }
    ...
    public void TC_LogValue_en() throws Exception
    {
        try
        {
            ...
            EN.LogValue("Name");
            //ImplementationMatrix.Instance.SetImplementation("SeTextField", "LogValue", "P");
        }
        catch (Exception e)
        {
            //ImplementationMatrix.Instance.SetImplementation("SeTextField", "LogValue", "F");
            throw e;
        }
    }
    ...
    public void TC_MemorizeExists_en() throws Exception
    {
        try
        {
            ...
            //ImplementationMatrix.Instance.SetImplementation("SeTextField", "MemorizeExists", "P");
        }
        catch (Exception e)
        {
            //ImplementationMatrix.Instance.SetImplementation("SeTextField", "MemorizeExists", "F");
            throw e;
        }
    }
    ...
    public void TC_MemorizeHasFocus_en() throws Exception
    {
        try
        {
            ...
            assertEquals("NO", myMM.Get("SeTextField_MemorizeHasFocus"));
            //ImplementationMatrix.Instance.SetImplementation("SeTextField", "MemorizeHasFocus", "P");
        }
        catch (Exception e)
        {
            //ImplementationMatrix.Instance.SetImplementation("SeTextField", "MemorizeHasFocus", "F");
            throw e;
        }
    }
    ...
    public void TC_MemorizeIsActive_en() throws Exception
    {
        try
        {
            ...
            assertEquals("YES", myMM.Get("SeTextField_MemorizeIsActive"));
            //ImplementationMatrix.Instance.SetImplementation("SeTextField", "MemorizeIsActive", "P");
        }
        catch (Exception e)
        {
            //ImplementationMatrix.Instance.SetImplementation("SeTextField", "MemorizeIsActive", "F");
            throw e;
        }
    }
    ...
    public void TC_MemorizeLabel_en() throws Exception
    {
        try
        {
            ...
            assertEquals("Name:", myMM.Get("SeTextField_MemorizeLabel_1"));
            assertEquals("Vorname:", myMM.Get("SeTextField_MemorizeLabel_2"));

            //ImplementationMatrix.Instance.SetImplementation("SeTextField", "MemorizeLabel", "P");
        }
        catch (Exception e)
        {
            //ImplementationMatrix.Instance.SetImplementation("SeTextField", "MemorizeLabel", "F");
            throw e;
        }
    }
    ...
    public void TC_MemorizeToolTip_en() throws Exception
    {
        try
        {
            ...
            assertEquals("Den Namen eingeben", myMM.Get("SeTextField_MemorizeTooltip"));

            //ImplementationMatrix.Instance.SetImplementation("SeTextField", "MemorizeToolTip", "P");
        }
        catch (Exception e)
        {
            //ImplementationMatrix.Instance.SetImplementation("SeTextField", "MemorizeToolTip", "F");
            throw e;
        }
    }
    ...
    public void TC_MemorizeValue_en() throws Exception
    {
        try
        {
            ...
            assertEquals("", myMM.Get("SeTextField_LogValue_1"));
            assertEquals("Zoltan", myMM.Get("SeTextField_LogValue_2"));

            //ImplementationMatrix.Instance.SetImplementation("SeTextField", "MemorizeValue", "P");
        }
        catch (Exception e)
        {
            //ImplementationMatrix.Instance.SetImplementation("SeTextField", "MemorizeValue", "F");
            throw e;
        }
    }
    ...
    public void TC_SetFocus_NoAttributeReadonly_en() throws Exception
    {
        try
        {
            ...
            //ImplementationMatrix.Instance.SetImplementation("SeTextField", "SetFocus", "P");
        }
        catch (Exception e)
        {
            //ImplementationMatrix.Instance.SetImplementation("SeTextField", "SetFocus", "F");
            throw e;
        }
    }
    ...
    public void TC_SetFocus_WithAttributeReadonly_en() throws Exception
    {
        try
        {
            EN.BeginTest( name.getMethodName() );
            EN.StartApp( ApplicationName );
            EN.TypeKey("URL", "http://test.openkeyword.de/TextField/TextField_readonly.htm");
    ...
    public void TC_SetValue_en() throws Exception
    {
        try
        {
            ...
            //ImplementationMatrix.Instance.SetImplementation("SeTextField", "SetValue", "P");
        }
        catch (Exception e)
        {
            //ImplementationMatrix.Instance.SetImplementation("SeTextField", "SetValue", "F");
            throw e;
        }
    }
    ...
    public void TC_TypeKey_en() throws Exception
    {
        try
        {
            ...
            //ImplementationMatrix.Instance.SetImplementation("SeTextField", "TypeKey", "P");
        }
        catch (Exception e)
        {
            //ImplementationMatrix.Instance.SetImplementation("SeTextField", "TypeKey", "F");
            throw e;
        }
    }
    ...
    public void TC_VerifyExists_NO_en() throws Exception
    {
        try
        {
            ...
            //ImplementationMatrix.Instance.SetImplementation("SeTextField", "VerifyExists", "P");
        }
        catch (Exception e)
        {
            //ImplementationMatrix.Instance.SetImplementation("SeTextField", "VerifyExists", "F");
            throw e;
        }
    }
    ...
    public void TC_VerifyExists_NO_YesObject_en()
    {
        try
        {
            ...
            // Hier darf die Ausführung nich vorbei kommen: Exception wurde nicht ausgelöst.
            //ImplementationMatrix.Instance.SetImplementation("SeTextField", "VerifyExists", "F");
            okw.log.Logger_Sngltn.getInstance().LogError( "Erwartete Exception wurde NICHT ausgelöst! - Fehler!" );
            fail("Erwartete Exception wurde NICHT ausgelöst! - Fehler!");
        }
        catch(Exception e)
        {
            // TODO Exception Prüfen: Wurde die richtige exception ausgelöst?
            okw.log.Logger_Sngltn.getInstance().LogPrint( "Erwartetet Exception wurde ausgelöst! - OK!" );
    ...
    /// Mit IGNORE darf keine Exception ausgelöst werden, weil das Schlüsselwort nicht ausgeführt wird.
    /// D.h. sollte eine Exception ausgelöstwerden, dann ist hier nicht ignoriert worden.
    /// 
    @Test
    ...
    public void TC_VerifyHasFocus_en() throws Exception
    {
        try
        {
            ...
            //ImplementationMatrix.Instance.SetImplementation("SeTextField", "VerifyHasFocus", "P");
        }
        catch (Exception e)
        {
            //ImplementationMatrix.Instance.SetImplementation("SeTextField", "VerifyHasFocus", "F");
            throw e;
        }
    }
    ...
    public void TC_VerifyIsActive_en() throws Exception
    {
        try
        {
           ...
           // Objekt auf "nicht aktiv"(attribut disabled gesetzt) prüfen
            EN.TypeKey("URL", "http://test.openkeyword.de/TextField/TextField_disabled.htm");
            ...
            //ImplementationMatrix.Instance.SetImplementation("SeTextField", "VerifyIsActive", "P");
        }
        catch (Exception e)
        {
            //ImplementationMatrix.Instance.SetImplementation("SeTextField", "VerifyIsActive", "F");
            throw e;
        }
    }
    ...
    public void TC_VerifyLabel_en() throws Exception
    {
        try
        {
            ...
            //ImplementationMatrix.Instance.SetImplementation("SeTextField", "VerifyLabel", "P");
        }
        catch (Exception e)
        {
            //ImplementationMatrix.Instance.SetImplementation("SeTextField", "VerifyLabel", "F");
            throw e;
        }
    }
    ...
    public void TC_VerifyTooltip_en() throws Exception
    {
        try
        {
            ...
            //ImplementationMatrix.Instance.SetImplementation("SeTextField", "VerifyTooltip", "P");
        }
        catch (Exception e)
        {
            //ImplementationMatrix.Instance.SetImplementation("SeTextField", "VerifyTooltip", "F");
            throw e;
        }
    }
    ...
    public void TC_VerifyValue_en() throws Exception
    {
        try
        {
            ...
            //ImplementationMatrix.Instance.SetImplementation("SeTextField", "VerifyValue", "P");
        }
        catch (Exception e)
        {
            //ImplementationMatrix.Instance.SetImplementation("SeTextField", "VerifyValue", "F");
            throw e;
        }
    }
    ...
    {
        //ImplementationMatrix.Instance.SetImplementation("SeTextField", "LogCaption", "N");
        //ImplementationMatrix.Instance.SetImplementation("SeTextField", "LogTablecellValue", "N");
        //ImplementationMatrix.Instance.SetImplementation("SeTextField", "MemorizeCaption", "N");
        //ImplementationMatrix.Instance.SetImplementation("SeTextField", "MemorizeTablecellValue", "N");
        //ImplementationMatrix.Instance.SetImplementation("SeTextField", "SelectMenu", "N");
        //ImplementationMatrix.Instance.SetImplementation("SeTextField", "SelectTablecell", "N");
        //ImplementationMatrix.Instance.SetImplementation("SeTextField", "StopApp", "N");
        //ImplementationMatrix.Instance.SetImplementation("SeTextField", "StartApp", "N");
        //ImplementationMatrix.Instance.SetImplementation("SeTextField", "VerifyCaption", "N");
        //ImplementationMatrix.Instance.SetImplementation("SeTextField", "VerifyTablecellValue", "N");
        //ImplementationMatrix.Instance.SetImplementation("SeTextField", "SelectWindow", "N");
    }
}	
