...
public class OKWSeParser extends Parser {
	...
	public static class RootContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof OKWSeParserListener ) ((OKWSeParserListener)listener).enterRoot(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof OKWSeParserListener ) ((OKWSeParserListener)listener).exitRoot(this);
		}
		@Override
	...
	public static class Okw_internal_varContext extends ParserRuleContext {
		...
		public TerminalNode FOLDER_LOGMESSAGES() { return getToken(OKWSeParser.FOLDER_LOGMESSAGES, 0); }
		public TerminalNode FOLDER_XML() { return getToken(OKWSeParser.FOLDER_XML, 0); }
		public TerminalNode FILE_OKW_CONST_XML() { return getToken(OKWSeParser.FILE_OKW_CONST_XML, 0); }
		public TerminalNode FILE_OKW_DOCU_XML() { return getToken(OKWSeParser.FILE_OKW_DOCU_XML, 0); }
		public TerminalNode FILE_OKW_IMPLEMENTATIONMATRIX_XML() { return getToken(OKWSeParser.FILE_OKW_IMPLEMENTATIONMATRIX_XML, 0); }
		public TerminalNode FILE_OKW_INI_XML() { return getToken(OKWSeParser.FILE_OKW_INI_XML, 0); }
		public TerminalNode FILE_OKW_KEYMAPS_XML() { return getToken(OKWSeParser.FILE_OKW_KEYMAPS_XML, 0); }
		public TerminalNode FILE_OKW_MEMORIZE_XML() { return getToken(OKWSeParser.FILE_OKW_MEMORIZE_XML, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof OKWSeParserListener ) ((OKWSeParserListener)listener).enterOkw_internal_var(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof OKWSeParserListener ) ((OKWSeParserListener)listener).exitOkw_internal_var(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof OKWSeParserVisitor ) return ((OKWSeParserVisitor<? extends T>)visitor).visitOkw_internal_var(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class Okw_typekeyContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof OKWSeParserListener ) ((OKWSeParserListener)listener).enterOkw_typekey(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof OKWSeParserListener ) ((OKWSeParserListener)listener).exitOkw_typekey(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof OKWSeParserVisitor ) return ((OKWSeParserVisitor<? extends T>)visitor).visitOkw_typekey(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class KeyvalueContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof OKWSeParserListener ) ((OKWSeParserListener)listener).enterKeyvalue(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof OKWSeParserListener ) ((OKWSeParserListener)listener).exitKeyvalue(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
	...
	public static class Okw_env_varContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof OKWSeParserListener ) ((OKWSeParserListener)listener).enterOkw_env_var(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof OKWSeParserListener ) ((OKWSeParserListener)listener).exitOkw_env_var(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof OKWSeParserVisitor ) return ((OKWSeParserVisitor<? extends T>)visitor).visitOkw_env_var(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class EnvvalueContext extends ParserRuleContext {
		public TerminalNode ENVVAL() { return getToken(OKWSeParser.ENVVAL, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof OKWSeParserListener ) ((OKWSeParserListener)listener).enterEnvvalue(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof OKWSeParserListener ) ((OKWSeParserListener)listener).exitEnvvalue(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof OKWSeParserVisitor ) return ((OKWSeParserVisitor<? extends T>)visitor).visitEnvvalue(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class TextContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof OKWSeParserListener ) ((OKWSeParserListener)listener).enterText(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof OKWSeParserListener ) ((OKWSeParserListener)listener).exitText(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
	...
	public static final String _serializedATN =
		"\3\u608b\ua72a\u8133\ub9ed\u417c\u3be7\u7786\u5964\3\23\62\4\2\t\2\4\3"+
		"\t\3\4\4\t\4\4\5\t\5\4\6\t\6\4\7\t\7\4\b\t\b\3\2\3\2\3\2\3\2\6\2\25\n"+
		"\2\r\2\16\2\26\3\3\3\3\3\3\3\3\3\4\3\4\3\4\3\4\7\4!\n\4\f\4\16\4$\13\4"+
		"\3\4\3\4\3\5\3\5\3\6\3\6\3\6\3\6\3\7\3\7\3\b\3\b\3\b\2\2\t\2\4\6\b\n\f"+
		"\16\2\3\3\2\b\17\2/\2\24\3\2\2\2\4\30\3\2\2\2\6\34\3\2\2\2\b\'\3\2\2\2"+
		"\n)\3\2\2\2\f-\3\2\2\2\16/\3\2\2\2\20\25\5\4\3\2\21\25\5\n\6\2\22\25\5"+
		"\6\4\2\23\25\5\16\b\2\24\20\3\2\2\2\24\21\3\2\2\2\24\22\3\2\2\2\24\23"+
		"\3\2\2\2\25\26\3\2\2\2\26\24\3\2\2\2\26\27\3\2\2\2\27\3\3\2\2\2\30\31"+
		"\7\3\2\2\31\32\t\2\2\2\32\33\7\6\2\2\33\5\3\2\2\2\34\35\7\3\2\2\35\"\5"+
		"\b\5\2\36\37\7\7\2\2\37!\5\b\5\2 \36\3\2\2\2!$\3\2\2\2\" \3\2\2\2\"#\3"+
		"\2\2\2#%\3\2\2\2$\"\3\2\2\2%&\7\6\2\2&\7\3\2\2\2\'(\7\21\2\2(\t\3\2\2"+
		"\2)*\7\3\2\2*+\5\f\7\2+,\7\6\2\2,\13\3\2\2\2-.\7\22\2\2.\r\3\2\2\2/\60"+
		"\7\4\2\2\60\17\3\2\2\2\5\24\26\"";
