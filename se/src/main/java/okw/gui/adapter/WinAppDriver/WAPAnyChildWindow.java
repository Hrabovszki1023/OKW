...
package okw.gui.adapter.WinAppDriver;
...
/**
 * @defgroup groupWinAppDriverClasses OKW Selenium Klassen
 * 
 * @defgroup groupWinAppDriverChildGUIAdapter OKW Childwindow GUI-Adapterklassen
 * @ingroup groupSeleniumClasses
 */

/**
 * \~
 * @defgroup groupWinAppDriverChildGUIAdapterTests JUnit-Testklassen für OKW Childwindow GUI-Adapterklassen
 * @ingroup groupSeleniumClasses
 */


/**
 * @ingroup groupWinAppDriverChildGUIAdapter
 * @author zoltan
 */
public class WAPAnyChildWindow extends AnyChildwindow
{
    ...
    *  @date 2019.03.27
    */
    public WAPAnyChildWindow( String fpsLocator, OKWLocatorBase... locators )
    {
    ...
    */
    public Boolean getExists()
    {
        ...
        try
        {
            ...
            meme = SeDriver.getInstance().getElements( myLocator );
    ...
    */
    ...
    public WebElement Me()
    {
        ...
        me = SeDriver.getInstance().getElement( this.getLocator() );
