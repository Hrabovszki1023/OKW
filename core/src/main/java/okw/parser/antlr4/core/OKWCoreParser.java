...
public class OKWCoreParser extends Parser {
	...
	public static class Okw_typekeyContext extends ParserRuleContext {
		...
		public TerminalNode KLAMMERZU() { return getToken(OKWCoreParser.KLAMMERZU, 0); }
		public List<TerminalNode> PLUS() { return getTokens(OKWCoreParser.PLUS); }
		public TerminalNode PLUS(int i) {
			return getToken(OKWCoreParser.PLUS, i);
		}
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof OKWCoreParserListener ) ((OKWCoreParserListener)listener).enterOkw_typekey(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof OKWCoreParserListener ) ((OKWCoreParserListener)listener).exitOkw_typekey(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof OKWCoreParserVisitor ) return ((OKWCoreParserVisitor<? extends T>)visitor).visitOkw_typekey(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class KeyvalueContext extends ParserRuleContext {
		public TerminalNode KEYVALUE() { return getToken(OKWCoreParser.KEYVALUE, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof OKWCoreParserListener ) ((OKWCoreParserListener)listener).enterKeyvalue(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof OKWCoreParserListener ) ((OKWCoreParserListener)listener).exitKeyvalue(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof OKWCoreParserVisitor ) return ((OKWCoreParserVisitor<? extends T>)visitor).visitKeyvalue(this);
			else return visitor.visitChildren(this);
		}
	}
