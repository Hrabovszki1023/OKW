 ...
 *  
 *  \~english
 *  Manages the frame classes centrally: Instantiates frame classes for frame objects and returns the references to them.
 *  
 *  \~
...
public class FrameObjectDictionary_Sngltn
{
	 ...
	 * 
	 * \~english
	 * The method delivers the GUI-Object of the given ChildObjecttest.
	 * 
