...
public class OKW_Const_Sngltn
{
	...
	// \~german
	// \brief Aktuelle Spracheinstellung (Current Language) wird in der
	// Klasse OKWLanguage verwaltet.<br/>
	// http://de.wikipedia.org/wiki/ISO-3166-1-Kodierliste
	//
	// \~english
	// \brief The actual language settings (current language) are
	...
	// \~german
	// \brief Referenz auf OKW.Log.LogMessenger
	//
	// \~english
	// \brief Reference to OKW.Log.LogMessenger
	//
	// \~
	//
	// \author Zoltan Hrabovszki
	...
	//
	// \~ \author Zoltan Hrabovszki \date 2013.12.22
	///
...
*/
	...
	// \~german
	// \brief Holt die einzige Instanz dieser Klasse.<br/>
	// <value> Die Instanz dieser Klasse. </value>
	//
	// Lazy Initialization (If required then only)
	//
	// \~english
	// \brief Gets the only instance of this class.<br/>
	...
	// \~german \brief Konvertiert WAHR/FALSCH (true/false) sprachabhängig nach
	// "Ja"/"Nein" (Yes/No) \param fpbTrueOrFalse WAHR oder FALSCH \return "Ja"
	// für true<br/> "Nein" für false
	//
	// \~english \brief Converts true/false language dependent to yes/no \param
	...
	public String Boolean2YesNo( Boolean fpbTrueOrFalse ) throws XPathExpressionException
	{
		...
		try
		{
			Log.LogFunctionStartDebug(this.getClass().getName() + ".Boolean2YesNo", "fpbTrueOrFalse",
					fpbTrueOrFalse.toString());
	...
	// \~german \brief Methode _verbindet_ die einzelne Strings eines
	...
	//
	// \~english \brief The method connects single strings of a list-String to
	...
	{
		Log.LogFunctionStartDebug(this.getClass().getName() + ".ConcatHSEP", "fpLs_ListString2Concat",
				fpLs_ListString2Concat.toString());
	...
	//
	// \~english \brief Method combines single strings of a listString to one
	...
	{
		Log.LogFunctionStartDebug(this.getClass().getName() + ".ConcatSEP", "fpLs_ListString2Concat",
				fpLs_ListString2Concat.toString());
	...
	// \~german \brief Methode _verbindet_ die einzelnen Strings eines
	// <code>List&lt;Strings&gt;</code> zu einem <code>string</code> und trennt
	...
	//
	// \~english \brief Method combines single strings of a listString to a
	...
	{
		Log.LogFunctionStartDebug(this.getClass().getName() + ".ConcatVSEP", "fpLs_ListString2Concat",
				fpLs_ListString2Concat.toString());
   ...
   *  </ul>
	...
	*/
	...
	//
	// | Internalname | OKW_Const (DE)| | -----------: | :------------ | | SEP |
	// ${SEP} | | VSEP | ${VSEP} | | HSEP | ${HSEP} | | DELETE | ${LÖSCHEN} | |
	// EMPTY | ${LEER} | | IGNORE | ${IGNORIEREN} |
	//
	// Beispiel: <code>"$IGNORIEREN" ==
	// GetOKWConst4Internalname("IGNORE")</code>
	//
	...
	//
	// \~english \brief Method detects for __Internalname__ and the actual
	...
	//
	// | Internalname | OKW_Const (DE)| | -----------: | :------------ | | SEP |
	// ${SEP} | | VSEP | ${VSEP} | | HSEP | ${HSEP} | | DELETE | ${DELETE} | |
	// EMPTY | ${EMPTY} | | IGNORE | ${IGNORE} |
	//
	...
	public String GetOKWConst4Internalname( String fpsInternalname ) 
	{
		...
		Log.LogFunctionStartDebug(this.getClass().getName() + ".GetOKWConst4Internalname", "fpsInternalname",
				fpsInternalname);

		try
		{
			lvsReturn = this.GetConst4Internalname("LEFTBRACE") + this.GetConst4Internalname(fpsInternalname)
	...
	// \~german
	// \brief Methode trennt einen String und wandelt diesen in eine
	...
	//
	// \see OKWConst::ConcatSEP()<br/> OKWConst::ConcatHSEP()<br/>
	...
	//
	// \~english
	// \brief Method separates a String and converts it to a
	...
	// \~german
	// \brief Methode trennt einen String und wandelt diesen in einen
	...
	// \~german \brief Methode trennt einen String und wandelt diesen in einen
	...
	// sind.<br/> Beispiel: "Wert1${VSEP}Wert2${VSEP}Wert2"
	//
	// \return Getrennte Werte als Liste. Beispiel: {"Wert1", "Wert2", "Wert3"}
	//
	// \~english \brief Method devides a String and converts it to a liststring.
	...
	// \~german
	// \brief Konvertiert sprachabhängig Ja/Nein zu einem Booleanean
	// Wert (Wahr/Falsch).<br/>
	//
	// Beispiele: Sprache ist "de": Eingabe "JA" -> Ausgabe Wahr <br/> Sprache
	// ist "de": Eingabe "NEIN" -> Ausgabe Falsch <br/> Sprache ist "en":
	...
	//
	// \param fpsYesOrNo sprachabhängig Ja/Nein \return WAHR wenn
	// sprachabhängiger Wert ist "Ja"<br/> FALSCH, wenn sprachabhängiger Wert
	// "Nein"
	//
	// \~english \brief Converts a Language dependent Yes/No to Boolean.<br/>
	//
	...
	//
	// \param fpsYesOrNo Language dependent Yes/No \return true if Language
	// dependent value is "yes"<br/> false if language dependent "No"
	//
	// \~
	// \author Zoltan Hrabovszki
	// \date 2013.12.09
	public Boolean YesNo2Boolean( String fpsYesOrNo ) throws XPathExpressionException
	{
		...
		try
		{
			...
			else
			{
				...
				String lvsMessage = LM.GetMessage("YesNo2Boolean", "ValueNotAllowed", fpsYesOrNo,
						lvs_Yes + "'/'" + lvs_No);
