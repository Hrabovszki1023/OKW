...
public class OKWLocatorXPathTest
{
    ...
    public void TC_4T_Window_Child()
    {
        ...
        assertEquals("//*[@data-4test='Window']", Window.getLocator());
        assertEquals("//*[@data-4test='Window']//*[@data-4test='Child']", Child.getLocator());
    }
    ...
    public void TC_4TNA_Window_Child()
    {
        ...
        assertEquals("//*[@data-4test='Window']", Window.getLocator());
        assertEquals("//*[@data-4test='Window']//*[contains(@name,'Child')]", Child.getLocator());
    }
    ...
    public void TC_4TID_Window_Child()
    {
        ...
        assertEquals("//*[@data-4test='Window']", Window.getLocator());
        assertEquals("//*[@data-4test='Window']//*[contains(@id,'Child')]", Child.getLocator());
    }
    ...
    public void TC_4TLA_Window_Child()
    {
        ...
        assertEquals("//*[@data-4test='Window']", Window.getLocator());
        assertEquals("//*[@data-4test='Window']//label[contains(text(),'Child')]/following-sibling::input", Child.getLocator());
    }
