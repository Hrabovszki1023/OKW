...
public class EN_Keywords_Test
{
	...
	/// \~german
	        ...
	        public void TC_MemorizeSelectedValue() throws Exception
	        {
	            ...
	            assertEquals("MemorizeSelectedValue_Return_1${SEP}MemorizeSelectedValue_Return_2", OKW_Memorize_Sngltn.getInstance().Get("TC_MemorizeSelectedValue_Key_1"));
	        }
	        ...
	        /// \~german
	        /// \brief
	        /// Prüft, ob ein einzelner Wert, oder ein einzelne Zeile an Type key Übertragen wird.
	        /// 
	        /// \~english
	        /// \~
	        /// \author Zoltan Hrabovszki
